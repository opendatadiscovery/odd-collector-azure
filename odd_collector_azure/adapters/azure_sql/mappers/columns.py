...
def map_column(
    ...
    mt = MetadataExtension(schema_url=_data_set_field_metadata_schema_url, metadata=column._asdict())
    ...
    dsf = DataSetField(
        ...
        type=DataSetFieldType(
            type=TYPES_SQL_TO_ODD.get(convert_bytes_to_str(column.data_type), Type.TYPE_UNKNOWN),
