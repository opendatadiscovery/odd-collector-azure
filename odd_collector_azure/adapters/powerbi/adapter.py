...
class Adapter(AbstractAdapter):
    ...
    @staticmethod
    def __create_dataset_id_oddrn_map(datasets_entities: List[DataEntity]) -> Dict[str, str]:
    ...
    async def __get_datasets_entities(self) -> List[DataEntity]:
        ...
        return [map_dataset(self.__oddrn_generator, dataset) for dataset in enriched_datasets]
